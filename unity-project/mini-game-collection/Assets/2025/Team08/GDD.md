**Game Design Document (Devcon 2)**



**Concept**

The concept for our game is that two players must work with each other to fend off waves of various attacking enemies for 60 seconds.
...
The game would start with a simple explanation for key game mechanics and button inputs. The explanation would be on both sides of the arcade machine, enabling both players to read it easily. Then, after both players press a button to "ready up", the game begins and the players must fight enemies. Either the enemies reach the player and a game over is triggered, or the player survive 30-60 seconds and a score is displayed for each player that displays how many enemies each player defeated.
